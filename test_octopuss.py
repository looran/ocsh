...
import unittest
from octopuss import Octopuss, Ssh_conf, Ssh_host
...
##octopuss: ^_host2:nc 127.0.0.1 3000
    Hostname 9.9.9.9
    User myuser
    Compression yes
"""
...
class Octopuss_unittest(unittest.TestCase):
    def test_parse_cmdline(self):
        expected_ssh_hosts = ["_host1", "^", "_host2"]
        o = Octopuss(["_host1", "^", "_host2"], sshconf=Ssh_conf(content=TEST_1_CONFIG))
    ...
    def test_build_connect_command(self):
        ...
        o = Octopuss(["_host1"], sshconf=Ssh_conf(content=TEST_1_CONFIG))
